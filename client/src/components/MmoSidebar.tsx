...
import { MessageSquare, Users, Send, ChevronRight, ChevronLeft } from 'lucide-react';
        ...
        <div className="h-full flex flex-col overflow-hidden animate-fadeIn">
          ...
          <div className="flex border-b border-white/5 bg-black/20 p-2 gap-1.5 shrink-0">
            <button
              ...
              className={`flex-1 py-1.5 rounded-lg text-[10px] font-display uppercase tracking-widest font-bold flex items-center justify-center gap-1.5 transition-all ${
                activeTab === 'CHAT'
          ...
          <div className="flex-1 overflow-hidden flex flex-col">
            {activeTab === 'CHAT' ? (
              ...
              <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-grow p-4 overflow-y-auto flex flex-col gap-2.5 custom-scrollbar">
                  {messages.length === 0 ? (
