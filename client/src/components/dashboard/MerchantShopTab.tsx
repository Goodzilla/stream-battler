    ...
    <div className="flex flex-col gap-6">
      ...
      <div className="glass-panel p-6 border-white/5 bg-black/25 flex flex-col gap-4 relative overflow-hidden">
        ...
        <p className="text-[10px] text-slate-400 leading-relaxed m-0 mb-2">
          Roll the dice for a random item. Mystery artifacts have an index cost scaling with your active character's level: <span className="text-yellow-500 font-bold">{character.level * 25 + 200} Gold</span>. High odds of Rare (51%), Epic (9%), and Legendary (1%) gear.
        </p>
