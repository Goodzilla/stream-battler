...
- Name: keystones.spec.ts >> Stream Raiders Clone - E2E Keystone Redesign Tests >> should verify allocating both Void Keystones Lethal Precision and Slayer Focus triggers double penalty (10% crit chance and 1.1x crit mult)
- Location: tests\e2e\keystones.spec.ts:153:7
