...
- Name: keystones.spec.ts >> Stream Raiders Clone - E2E Keystone Redesign Tests >> should verify allocating both Vampiric Zeal and Ghost Reaver triggers double penalty (0% lifesteal and reduced HP benefits)
- Location: tests\e2e\keystones.spec.ts:65:7
