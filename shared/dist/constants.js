...
export const PASSIVE_SKILL_TREE = {};
...
buildPassiveTree();
export const validatePassiveAllocation = (allocatedNodes) => {
...
export const RAID_ARENA_CONFIGS = {
    'Goblin King': {
...
export const getArenaConfigForLevel = (level) => {
