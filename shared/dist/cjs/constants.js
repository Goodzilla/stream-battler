...
exports.PASSIVE_SKILL_TREE = {};
const buildPassiveTree = () => {
    exports.PASSIVE_SKILL_TREE['start'] = {
        id: 'start',
    ...
    const sectors = ['atk', 'def', 'life', 'speed', 'crit'];
    const labels = {
    ...
    const connect = (id1, id2) => {
        if (exports.PASSIVE_SKILL_TREE[id1] && exports.PASSIVE_SKILL_TREE[id2]) {
            if (!exports.PASSIVE_SKILL_TREE[id1].connections.includes(id2)) {
                exports.PASSIVE_SKILL_TREE[id1].connections.push(id2);
            }
            if (!exports.PASSIVE_SKILL_TREE[id2].connections.includes(id1)) {
                exports.PASSIVE_SKILL_TREE[id2].connections.push(id1);
            }
        }
    };
    ...
    for (let s = 0; s < 5; s++) {
        ...
        const addNode = (id, r, angle, isNotable = false, customStats, customName, customDesc) => {
        ...
        exports.PASSIVE_SKILL_TREE[keyId] = {
            id: keyId,
            name: keyName,
            description: keyDesc,
            x: xKey,
        ...
        exports.PASSIVE_SKILL_TREE[outerKey1Id] = {
            id: outerKey1Id,
            name: outerKey1Name,
        ...
        exports.PASSIVE_SKILL_TREE[outerKey2Id] = {
            id: outerKey2Id,
            name: outerKey2Name,
        ...
        exports.PASSIVE_SKILL_TREE[celKey1Id] = {
            id: celKey1Id,
            name: celKey1Name,
        ...
        exports.PASSIVE_SKILL_TREE[celKey2Id] = {
            id: celKey2Id,
            name: celKey2Name,
        ...
        exports.PASSIVE_SKILL_TREE[voidKey1Id] = {
            id: voidKey1Id,
            name: voidKey1Name,
        ...
        exports.PASSIVE_SKILL_TREE[voidKey2Id] = {
            id: voidKey2Id,
            name: voidKey2Name,
...
buildPassiveTree();
const validatePassiveAllocation = (allocatedNodes) => {
    if (allocatedNodes.length === 0)
        return true;
    if (!allocatedNodes.includes('start'))
        return false;
    ...
    while (queue.length > 0) {
        ...
        const node = exports.PASSIVE_SKILL_TREE[curr];
        if (!node)
            continue;
...
const getArenaConfigForLevel = (level) => {
    ...
    return exports.ARENA_CONFIGS[selectedLevel];
};
exports.getArenaConfigForLevel = getArenaConfigForLevel;
